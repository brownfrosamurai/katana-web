    ...
    <Container className="hero-grid-bg w-full">
      <div className="section-padding">
        ...
        <p className="page-intro">
          I help start-ups and businesses build end to end experiences for their
          users.{' '}
        </p>
            ...
            {sortedProjects.map((project, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="sticky top-[100px] w-full shrink-0 self-start md:w-1/4">
                    <div
                      className={cn(
                    ...
                    >
                      {project.description}
                      <p className="mt-1 font-mono text-sm uppercase tracking-wide text-neutral-600 dark:text-neutral-400">
